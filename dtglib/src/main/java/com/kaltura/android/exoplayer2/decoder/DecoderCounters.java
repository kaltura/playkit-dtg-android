...
final class DecoderCounters {
   ...
   */
  private int decoderInitCount;
  /**
   * The number of times a decoder has been released.
   */
  private int decoderReleaseCount;
  /**
   ...
   */
  private int skippedInputBufferCount;
  /**
   ...
   */
  private int maxConsecutiveDroppedBufferCount;
  /**
   ...
   */
  private int droppedToKeyframeCount;
