 ...
 */
package com.kaltura.android.exoparser.source.hls.playlist;
...
import com.kaltura.android.exoparser.source.UnrecognizedInputFormatException;
...
public final class HlsPlaylistParser {
  ...
  public Boolean containsEncryptionKey(String line) {
    return line.contains(METHOD_AES_128);
  }
  ...
  private static HlsMasterPlaylist parseMasterPlaylist(LineIterator iterator, String baseUri)
    ...
    ArrayList<Integer> mediaTagsLineNums = new ArrayList<>();
...
//        }
    ...
    for (int i = 0; i < mediaTags.size(); i++) {
      ...
      lineNum = mediaTagsLineNums.get(i);
  ...
  private static HlsMediaPlaylist parseMediaPlaylist(LineIterator iterator, String baseUri)
    ...
    while (iterator.hasNext()) {
      ...
      if (line.startsWith(TAG_PLAYLIST_TYPE)) {
        ...
        initializationSegment = new HlsMediaPlaylist.Segment(uri, segmentByteRangeOffset, segmentByteRangeLength, iterator.lineNum, encryptionKeyLineNum);
        ...
        if (!METHOD_NONE.equals(method)) {
          ...
          if (KEYFORMAT_IDENTITY.equals(keyFormat) || keyFormat == null) {
            ...
            DrmInitData.SchemeData schemeData = parseWidevineSchemeData(line, keyFormat);
            if (schemeData != null) {
              drmInitData =
                  new DrmInitData(
        ...
        segments.add(
            new HlsMediaPlaylist.Segment(
                ...
                hasGapTag,
                    iterator.lineNum, encryptionKeyLineNum));
  ...
  private static DrmInitData.SchemeData parseWidevineSchemeData(String line, String keyFormat)
      throws ParserException {
    if (KEYFORMAT_WIDEVINE_PSSH_BINARY.equals(keyFormat)) {
     String uriString = parseStringAttr(line, REGEX_URI);
     return new DrmInitData.SchemeData(C.WIDEVINE_UUID, MimeTypes.VIDEO_MP4,
  ...
  private static class LineIterator {
    ...
    boolean hasNext() throws IOException {
      ...
      while ((next = extraLines.poll()) != null) {
        lineNum++;
        if (!next.isEmpty()) {
          return true;
        }
